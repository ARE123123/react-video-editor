	...
	return (
		<div className='wrapper'>
			...
			<div className='controls'>
				...
				<div>
					<button title='Add grabber' className='trim-control margined' onClick={addGrabber}>添加 <FontAwesomeIcon icon={faGripLinesVertical} /></button>
					<button title='Delete grabber' className='trim-control margined' onClick={preDeleteGrabber}>删除 <FontAwesomeIcon icon={faGripLinesVertical} /></button>
					<button title='Save changes' className='trim-control' onClick={saveVideo}>保存</button>
				</div>
			</div>
			{ready ?
				<div></div>
